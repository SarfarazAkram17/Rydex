...
const Page = () => {
  ...
  if (loading) {
    return (
      <div className="min-h-screen grid place-items-center text-gray-600 animate-pulse">
        Loading Partner...
      </div>
    );
  }
        ...
        <div className="lg:col-span-2 space-y-8">
          ...
          <AnimatedCard title="Documents" icon={<FileText size={18} />}>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              />
              <DocPreview
                label="Registration Centificate"
            ...
            >
              ...
              <p className="text-sm text-gray-500 mt-2">
                <textarea
                  ...
                  className="w-full mt-3 border rounded-xl p-3 text-sm resize-none"
                />
              </p>
              <div className="flex gap-3 mt-6">
                <button
