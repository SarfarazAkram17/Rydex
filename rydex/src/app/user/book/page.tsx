      ...
      >
        <div className="flex items-center gap-4 mb-6 px-1">
          <motion.button
            onClick={() => router.push("/")}
            whileTap={{ scale: 0.88 }}
            className="w-11 h-11 cursor-pointer rounded-2xl bg-white border border-zinc-200 shadow-sm flex items-center justify-center hover:bg-zinc-50 transition-colors shrink-0"
          >
        ...
        <div className="bg-white rounded-3xl border border-zinc-200 shadow-[0_8px_40px_rgba(0,0,0,0.08)] overflow-visible">
          ...
          <div className="p-6 space-y-7">
                ...
                {VEHICLES.map((v, i) => {
                  ...
                  return (
                    <motion.div
                      ...
                      whileTap={{ scale: 0.95 }}
                      className={`relative p-3.5 cursor-pointer rounded-2xl border flex items-center gap-3 text-left transition-all duration-200 ${active ? "bg-zinc-900 border-zinc-900 shadow-lg" : "bg-zinc-50 border-zinc-200 hover:border-zinc-400"}`}
                    >
                      <div
            ...
            >
              ...
              <div className="border border-zinc-200 bg-zinc-50 rounded-2xl overflow-visible">
                <div className="relative z-30">
                  <div className="flex items-center gap-3 px-4 py-3.5 focus-within:bg-white rounded-t-2xl transition-colors">
                    ...
                    <motion.button
                      ...
                      whileTap={{ scale: 0.88 }}
                      disabled={locating}
                      className="w-8 h-8 rounded-xl cursor-pointer bg-zinc-200 hover:bg-zinc-300 transition-colors flex items-center justify-center shrink-0"
                    >
                      <LocateFixed
                        size={14}
                  ...
                  <AnimatePresence>
                    {pickUpSuggestions?.length > 0 && (
                      <motion.div
                        ...
                        className="absolute left-0 right-0 top-full mt-1 bg-white border border-zinc-200 rounded-lg shadow-xl max-h-28 overflow-y-auto z-50"
                      >
                        {pickUpSuggestions.map((p, i) => (
                          <motion.div
                            ...
                            className="flex cursor-pointer items-center gap-3 w-full px-4 py-3 text-left hover:bg-zinc-50 transition-colors border-b border-zinc-100 last:border-0"
                          >
                            <MapPin
                              size={13}
            ...
            >
              <motion.button
                ...
                className="w-full h-14 rounded-2xl cursor-pointer disabled:cursor-not-allowed bg-zinc-900 hover:bg-black disabled:opacity-35 text-white font-black text-sm tracking-wide flex items-center justify-center gap-2.5 transition-colors shadow-lg disabled:shadow-none"
              >
                <span>Continue</span>
              </motion.button>
            </motion.div>
