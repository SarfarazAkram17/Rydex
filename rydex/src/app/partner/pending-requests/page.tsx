                  ...
                  <div className="flex-1 space-y-6">
                    ...
                    <div className="flex items-center gap-2 text-sm text-gray-500 mt-2">
                      ...
                      <span className="font-medium">
                        {new Date(b.createdAt!).toLocaleString("en-BD", {
                          day: "2-digit",
                          month: "short",
                          year: "numeric",
                          hour: "2-digit",
                  ...
                  <div className="flex flex-col justify-between lg:items-end gap-6 w-full lg:w-auto">
                    ...
                    <div className="flex w-full gap-4 lg:w-auto">
                      ...
                      <button
                        ...
                        className="flex-1 lg:flex-none px-8 py-3 rounded-xl bg-black text-white text-sm font-semibold shadow-md hover:bg-gray-900 hover:shadow-lg transition-all duration-200 active:scale-[0.98] disabled:opacity-50 flex items-center justify-center cursor-pointer"
                      >
                        Accept Ride
                      </button>
                    </div>
