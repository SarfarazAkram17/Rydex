...
const Page = () => {
  ...
  const [etaToDrop, setEtaToDroup] = useState(0);
    ...
    return (
      <div className="h-screen w-full bg-zinc-950 flex items-center justify-center">
        <div className="flex flex-col items-center gap-4">
          ...
          <p className="text-white/40 text-sm tracking-widest uppercase font-medium animate-pulse">
            Loading Ride...
          </p>
        </div>
      </div>
  ...
  if (!booking) {
    return (
      <div className="bg-black w-fulll h-screen flex justify-center items-center text-[20px] text-white">
  ...
  return (
    <div className="h-screen w-full bg-zinc-100 flex flex-col lg:flex-row overflow-hidden">
      ...
      >
        <div className="px-6 py-5 shrink-0 bg-zinc-950">
          <p className="text-zinc-400 text-[10px] tracking-[0.2em] uppercase font-semibold mb-1">
            Driver Panel
          </p>

          <div className="flex items-center justify-between">
            <h1 className="text-zinc-500">Active Ride</h1>
            {isActive && (
              <div className="flex items-center gap-2 bg-white/10 px-3 py-1.5 rounded-full text-zinc-400">
                <Zap className="text-amber-400" size={12} />
                <span>{Math.round(displayEta)} min</span>
              </div>
            )}
          </div>
        </div>
            ...
            <AnimatePresence mode="wait">
              {status === "confirmed" && !otpMode && !otpVerified && (
                <motion.button
                  ...
                  className="w-full bg-zinc-900 cursor-pointer hover:bg-zinc-800 active:scale-[97] text-white py-4 rounded-2xl font-bold text-sm tracking-widest transition-all flex items-center justify-center gap-2"
                >
              ...
              {status === "confirmed" && otpMode && !otpVerified && (
                ...
                >
                  <div className="bg-zinc-950 px-4 py-3 flex items-center gap-2">
                    ...
                    <p className="text-white text-shadow-2xs font-bold tracking-wide uppercase">
                      Enter Customer OTP
                    </p>
                  </div>
                  ...
                  <div className="p-4 space-y-3">
                    ...
                    <div className="flex gap-2">
                      <button
                        className="flex-1 border border-zinc-200 bg-white text-zinc-700 py-2.5 rounded-xl text-sm font-semibold active:scale-[0.97] transition-all cursor-pointer"
                        onClick={() => {
                          setOtpMode(false);
                          setOtp("");
                          setOtpError("");
                      ...
                      <button
                        className="flex-1 bg-zinc-900 hover:bg-zinc-800 disabled:opacity-40 text-white py-2.5 rounded-xl text-sm font-bold active:scale-[0.97] transition-all cursor-pointer"
