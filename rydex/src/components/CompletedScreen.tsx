    ...
    >
      <div className="flex-1 flex flex-col items-center justify-center px-6 py-12">
        <motion.div
          ...
          className="mb-8"
        >
          <div className="flex items-center justify-center w-32 h-32 rounded-full bg-emerald-400/10">
            <div className="w-24 h-24 rounded-full flex items-center justify-center bg-emerald-400/20">
        ...
        >
          ...
          <p className="text-zinc-500 text-sm text-center mb-8">
            {role == "driver"
              ? "Your have successfully dropped the customer."
          ...
          <button
            onClick={() => router.push("/")}
            className="w-full border border-zinc-700 text-zinc-400 py-3.5 rounded-2xl text-sm font-semibold hover:bg-zinc-900 transition-colors cursor-pointer"
          >
            Back To Home
          </button>
        </motion.div>
