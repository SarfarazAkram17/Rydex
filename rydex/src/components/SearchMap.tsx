...
const pickUpIcon = new L.DivIcon({
  html: `<div style='display:flex; flex-direction:column; align-items:center; filter:drop-shadow(0 6px 18px rgba(0,0,0,0.22);'>
    <div style='background:#0a0a0a; color:#fff; padding:5px 14px; border-radius: 100px; font-size: 10px; font-weight: 800; letter-spacing:nowrap; font-family:-apple-system, ststem-ui, sans-serif; box-shadow: 0 2px 12px rgba(0,0,0,0.25);'>
    PICKUP
    </div>
    <div style='width:2px; height:10px; background: #0a0a0a; opacity: 0.4;'></div>
    <div style='width:13px; height:13px; background:#0a0a0a; border-radius: 50%; border:3px solid #fff; box-shadow: 0 0 0 2px rgba(0,0,0,0.15);'></div>
    </div>`,
  className: "",
  iconSize: [90, 58],
  iconAnchor: [45, 58],
