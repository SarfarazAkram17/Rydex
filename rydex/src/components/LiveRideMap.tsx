...
const LiveRideMap = ({
  ...
  useEffect(() => {
    ...
    fetchRoutes();
  }, [driverLocation, dropLocation, pickUpLocation, mapStatus]);
  ...
  function FitBounds({
    ...
    useEffect(() => {
      map.invalidateSize();
      map.fitBounds([driverLocation, pickUpLocation, dropLocation], {
        padding: [72, 72],
        maxZoom: 15,
        animate: true,
        duration: 1,
      });
    }, [driverLocation, pickUpLocation, dropLocation, map]);
    return null;
  }
