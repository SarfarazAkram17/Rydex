            ...
            <div className="flex gap-2 mt-2">
              ...
              {canChat && (
                <button
                  ...
                  className={`flex flex-1 items-center justify-center gap-2 active:scale-[0.97] transition-all py-3 rounded-xl text-sm font-semibold cursor-pointer ${chatOpen ? "bg-zinc-200 text-zinc-900" : "bg-zinc-900 hover:bg-zinc-800 text-white"}`}
                >
          ...
          <div className="bg-zinc-50 border border-zinc-100 rounded-2xl p-4 flex items-center gap-3">
            ...
            <div className="shrink-0 bg-zinc-900 px-3 py-1.5 rounded-lg">
              <p className="text-white text-xs font-black tracking-widest font-mono">
                {booking.vehicle.number ?? "Vehicle Number"}
              </p>
            </div>
          </div>
        </div>
