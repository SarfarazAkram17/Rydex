    ...
    >
      <div className="relative h-48 bg-zinc-50 flex items-center justify-center overflow-hidden">
        ...
        <motion.img
          ...
          style={{ fill: "drop-shadow(0 8px 24px rgba(0,0,0,0.14))" }}
          whileHover={{
            scale: 1.06,
      ...
      <div className="flex flex-col flex-1 p-5 gap-4">
        ...
        <div className="grid grid-cols-2 gap-2">
          <div className="border border-zinc-100 rounded-2xl px-3.5 py-3 bg-zinc-50">
        ...
        <div className="flex items-end justify-between pt-3 border-t border-zinc-100">
          ...
          <motion.button
            ...
            onClick={onBook}
            disabled={distance == 0}
            className="flex items-center disabled:opacity-50 cursor-pointer gap-2 bg-zinc-900 hover:bg-black text-white text-sm font-black px-6 py-3.5 rounded-2xl transition-colors shadow-md"
          >
            Book{" "}
            <motion.div
              initial={{ x: 0 }}
