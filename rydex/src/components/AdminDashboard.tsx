...
type Stats = {
  ...
  totaleApprovedPartners: number;
  totalePendingPartners: number;
  totaleRejectedPartners: number;
};
      ...
      <main className="max-w-7xl mx-auto px-6 py-12 space-y-16">
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
          ...
          <Kpi
            ...
            value={stats?.totaleApprovedPartners}
            icon={<CheckCircle2 />}
            varient="approved"
          />
          <Kpi
            label="Pending Partners"
            value={stats?.totalePendingPartners}
            icon={<Clock />}
            varient="pending"
          />
          <Kpi
            label="Rejected Partners"
            value={stats?.totaleRejectedPartners}
            icon={<XCircle />}
            varient="rejected"
          />
        </div>
