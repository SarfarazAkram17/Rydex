            ...
            <div className="p-8 sm:p-10">
              ...
              <div className="flex items-end justify-between pt-6 border-t border-zinc-100">
                <div>
                  ...
                  <p className="text-zinc-400 text-shadow-2xs font-medium">
                ...
                {(status == "idle" || status == "rejected") && (
                  ...
                  >
                    <div>
                      ...
                      <div className="border border-zinc-100 rounded-2xl p-5 space-y-3 bg-zinc-50">
                        {[
                          {
                            icon: <Clock size={14} />,
                      ...
                      {[
                        ...
                        return (
                          <motion.div
                            ...
                            className={`w-full flex cursor-pointer items-center gap-4 p-4 rounded-2xl border-2 text-left transition-all duration-200 ${active ? "bg-zinc-900 border-zinc-900" : "bg-zinc-50 border-zinc-200 hover:border-zinc-400"}`}
                          >
                            <div
                              className={`w-10 h-10 flex items-center justify-center rounded-xl shrink-0 transition-colors ${active ? "bg-white/10" : "bg-zinc-200"}`}
                            >
                              <p.Icon
                                size={18}
                                className={
                ...
                {status == "confirmed" && (
                  ...
                  >
                    ...
                    <motion.button
                      ...
                      className="flex items-center gap-2.5 bg-zinc-900 cursor-pointer hover:bg-black text-white font-black text-sm px-8 py-4 rounded-2xl transition-colors shadow-md"
                    >
