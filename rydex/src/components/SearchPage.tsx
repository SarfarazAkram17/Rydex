    ...
    <div className="min-h-screen bg-zinc-100 text-zinc-900 overflow-x-hidden">
      <div className="absolute top-5 left-5 z-50">
        <motion.button
          onClick={() => router.back()}
          whileTap={{ scale: 0.88 }}
          className="w-11 h-11 cursor-pointer rounded-full bg-white border border-zinc-200 shadow-sm flex items-center justify-center hover:bg-zinc-50 transition-colors"
        >
            ...
            {!loading && vehicles.length == 0 && (
              ...
              >
                ...
                <motion.button
                  ...
                  className="mt-5 flex cursor-pointer items-center gap-2 bg-zinc-900 text-white text-sm font-semibold px-6 py-2.5 rounded-xl hover:bg-zinc-800 transition-colors"
                >
